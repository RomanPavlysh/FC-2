package com.christophesmet.maskablelayout;
...
public class MaskableFrameLayout extends FrameLayout {
        ...
        if (theme != null) {
            ...
            try {
                ...
                mPorterDuffXferMode = getModeFromInteger(
                        a.getInteger(R.styleable.MaskableFrameLayout_porterduffxfermode, 0));
    ...
    private Drawable loadMask(@NonNull TypedArray a) {
        return a.getDrawable(R.styleable.MaskableFrameLayout_mask);
    }
