...
public class ListAdepter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        ImageView detailImageView = rowView.findViewById(R.id.detailImageView);
        TextView text_detail_name = rowView.findViewById(R.id.text_detail_name);
        TextView text_detail_value = rowView.findViewById(R.id.text_detail_value);
        CardView card = rowView.findViewById(R.id.about_1);
